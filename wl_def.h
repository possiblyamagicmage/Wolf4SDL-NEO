...
#define DOORIMAGECOUNT  12
#define DOORWALL        (PMSpriteStart - DOORIMAGECOUNT)

#define MAXACTORS       300         // max number of nazis, etc / map
#define MAXSTATS        800         // max number of lamps, bonus, etc
...
#define AREATILE        200         // first of NUMAREAS floor tiles
#define NUMAREAS        37
#define ELEVATORTILE    21
#define DOORSTART       90          // WALL - first door code
#define DOOREND         101         // WALL - last door code
#define AMBUSHTILE      199
#define ALTELEVATORTILE 200
...
//
    ...
    SPR_STAT_20,SPR_STAT_21,
    SPR_STAT_22,SPR_STAT_23,
...
// control info
//
boolean             mouseenabled,joystickenabled,doscontrols;
extern  int         dirscan[4];
extern  int         buttonscan[NUMBUTTONS];
extern  int         buttonmouse[5];
extern  int         buttonjoy[31];
